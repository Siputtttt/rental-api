...
public $search ;
    ...
    { 
        ...
        if( $request-><?php echo e($moduleDBKey); ?> != '') {
           
            <?php echo e($modelClassName); ?>::updateData( $posts , $request-><?php echo e($moduleDBKey); ?>  );
            $action = 'update';        
            $message = " Data has been updated ";
        } else { 
            <?php echo e($modelClassName); ?>::insertData( $posts );
            $action = 'insert';        
            $message = " Data has been inserted ";
        }
        // Insert Log History
        <?php echo e($modelClassName); ?>::auditLogs( $request->user()->id , '<?php echo e($moduleName); ?>', $action, $posts);
        return response()->json([
            'status'      => 1 , 
            'posts'         => $posts,
            'message'     => $message
    ...
    public function destroy($ids)
    {
        ...
        try {
            <?php echo e($modelClassName); ?>::deleteData( $ids );
...
<?php /**PATH /Users/haimac/Documents/jobs/side/rental-api/resources/views/crud/Controller.blade.php ENDPATH**/ ?>